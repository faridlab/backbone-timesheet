//! Domain policy for RateCard aggregate
//!
...
/// Domain policy for RateCard — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<RateCard>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type RateCardDomainPolicy = PermitAllPolicy<RateCard>;
