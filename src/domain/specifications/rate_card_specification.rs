//! Specifications for RateCard aggregate
//!
...
// Each predicate implements `Specification<RateCard>` and can be combined
...
//
// pub struct ActiveRateCardSpec;
// impl Specification<RateCard> for ActiveRateCardSpec {
//     fn is_satisfied_by(&self, e: &RateCard) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
